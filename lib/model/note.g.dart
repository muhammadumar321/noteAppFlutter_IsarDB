...
Id _notesGetId(Note object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _notesGetLinks(Note object) {
  return [];
}

void _notesAttach(IsarCollection<dynamic> col, Id id, Note object) {
  object.id = id;
}

extension NotesQueryWhereSort on QueryBuilder<Note, Note, QWhere> {
...
extension NotesQueryWhere on QueryBuilder<Note, Note, QWhereClause> {
...
extension NotesQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
...
extension NotesQueryObject on QueryBuilder<Note, Note, QFilterCondition> {}

extension NotesQueryLinks on QueryBuilder<Note, Note, QFilterCondition> {}

extension NotesQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
...
extension NotesQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
...
extension NotesQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
...
extension NotesQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
